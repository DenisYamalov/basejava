...
public class ResumeTestData {
    ...
    private static void addExperience(Resume resume) {
        ...
        company1.getPeriods().add(new Period(LocalDate.of(2013, Month.OCTOBER, 1), LocalDate.now(),
                "Создание, организация и проведение Java онлайн проектов и стажировок.",
                "Автор проекта."));

        Company company2 = new Company("Wrike", "https://www.wrike.com");
        company2.getPeriods().add(new Period(LocalDate.of(2014, Month.OCTOBER, 1),
                LocalDate.of(2016, Month.JANUARY
                , 1), "Проектирование и разработка онлайн платформы управления проектами " +
    ...
    private static void addEducation(Resume resume) {
        ...
        Company company1 = new Company("Coursera", "https://www.coursera.org/course/progfun.html?ID=22366");

        company1.getPeriods().add(new Period(LocalDate.of(2013, Month.MARCH, 1),
                LocalDate.of(2013, Month.APRIL, 1),
                "'Functional " + "Programming Principles in Scala' by Martin Odersky"));

        Company company2 = new Company("Luxoft", "http://www.luxoft-training.ru/training/catalog/course");
        company1.getPeriods().add(new Period(LocalDate.of(2011, Month.MARCH, 1),
                LocalDate.of(2011, Month.APRIL, 1),
                "Курс 'Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.'"));

        education.getCompanies().add(company1);
        education.getCompanies().add(company2);
